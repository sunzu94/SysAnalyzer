...
Source: "./\api_log.dll"; DestDir: "{app}"; 
Source: "./\api_logger.exe"; DestDir: "{app}"; 
Source: "./\dir_watch.dll"; DestDir: "{app}"; 
Source: "./\exploit_sigs.txt"; DestDir: "{app}"; 
Source: "./\proc_analyzer.exe"; DestDir: "{app}"; 
Source: "./\safe_test1.exe"; DestDir: "{app}"; 
Source: "./\sniff_hit.exe"; DestDir: "{app}"; 
Source: "./\sysAnalyzer.exe"; DestDir: "{app}"; 
...
Name: "{userdesktop}\SysAnalyzer"; Filename: "{app}\sysAnalyzer.exe"; WorkingDir: "{app}"; 
